    ...
    <div class="tables">
        <button v-on:click="newTable">New table</button>
            <div class="field-container" v-on:mousemove="moveTable">
                <div v-for="(el, index) in AllTables" v-bind:key="index" class="table" 
                    ...
                    v-bind:style="{
                        ...
                        'border-radius': el.radius+'px'
                            ...
                            <div v-show="el.blocked">
                                <button v-on:click="el.width += 10">+</button>
                                <button v-on:click="el.width -= 10">-</button><br>
                                <button v-on:click="el.height += 10">+</button>
                                <button v-on:click="el.height -= 10">-</button><br>
...
export default {
    ...
    data () {
        return {
            AllTables: [
                {text: 'Table1', top: 10, left: 50, active: false, width: 200, height: 100, radius: 0, layerX: 0, layerY: 0, blocked: false},
                {text: 'Table2', top: 50, left: 350, active: false, width: 200, height: 100, radius: 50, layerX: 0, layerY: 0, blocked: false},
                {text: 'Table3', top: 350, left: 350, active: false, width: 200, height: 100, radius: 50, layerX: 0, layerY: 0, blocked: false},
            ],
            countClicks: 0,
            clickInterval: null
        }
    ...
    methods: {
        ...
        changeRadius (element) {
            this.AllTables[element].radius = this.AllTables[element].radius == 50 ? 0 : 50
        },
