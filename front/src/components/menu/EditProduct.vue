      ...
      <div class="col-10 col-sm-11">
        <div class="container-fluid mt-2 mb-5">
          ...
          <div class="row">
            ...
            <b-form-file accept="image/*" v-model="product.photo" id="upload" class="mt-3" plain></b-form-file>
            <div class="col-lg-4 align-self-center">
              ...
              <div v-if="product.photo" class="mt-3">
                <img
                  v-b-modal.modal1
                ...
                <b-modal id="modal1" size="lg" style="text-align: center;">
                  <img :src="product.photo" alt style="width: 600px; height: auto;">
                </b-modal>
              </div>
            </div>
          </div>
